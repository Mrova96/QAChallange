...
/*
Task 1
Import array users (from user1.json file) and write a function that will check if the phone number for every single user contains only digits
Result:
...
Task 2
Import array users (from user1.json file) and users (from user2.js file) and compare them
Result:
